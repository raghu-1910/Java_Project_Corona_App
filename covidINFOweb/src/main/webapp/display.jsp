...
#covid tr:hover {background-color: #ccffe6;}
...
<h3 align="center">QUERY FETCHED : <span style="color:grey">SELECT location, total_cases FROM coviddata</span></h3>
<h3 align="center"><span style="color:grey">WHERE new_cases>10000 GROUP BY location,total_cases ORDER BY total_cases;</span></h3>
<h3 align="center">CSV File : <span style="color:grey">covid-19-data/public/data/latest/owid-covid-latest.csv</span></h3>
<table id="covid">
<tr></tr>
